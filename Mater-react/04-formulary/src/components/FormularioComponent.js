...
const ForumularioComponent = () => {
    ...
    const cambiarDatos = e => {
      let name_del_inpu = e.target.name;
      let usuario_para_modificar = usuario;

      //usuario_para_modificar[name_del_inpu] = e.target.value

      setUsuario(estado_previo => ({
    
          ...estado_previo,
          [name_del_inpu]: e.target.value
        })
      );
...
export default ForumularioComponent